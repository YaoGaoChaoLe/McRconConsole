...
**另一个项目：提交latest.log，本地分析日志** - https://yaogaochaole.github.io/McRconConsole/
...
- **服务器崩溃处理** – 自动检查服务器是否崩溃。崩溃后可以发送邮件进行提示、执行预设的批处理脚本（例如崩溃后自动重启服务器）。
...
本项目代码完全由ai(deepseek v4)生成，个人定制自用，请自行检查代码。
